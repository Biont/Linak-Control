...
export default class Background {
    ...
    /**
     * TODO: Wire this up to some before-quit event from electron. Then deregister all ipc handlers and scheduled tasks.
     *
     * This will hopefully get rid of "Object has been destroyed" errors on quitting the program.
     */
    tearDown() {
        this.stopLoop();
    }
