...
var _LazyLoadView = require('./LazyLoadView');
...
var AppView = function (_LazyLoadView$extend) {
    _inherits(AppView, _LazyLoadView$extend);

    function AppView() {
        _classCallCheck(this, AppView);

        return _possibleConstructorReturn(this, _LazyLoadView$extend.apply(this, arguments));
    }

    AppView.prototype.render = function render(force) {
        var rendered = this.rendered;
        _LazyLoadView$extend.prototype.render.call(this, force);
    ...
    return AppView;
}(_LazyLoadView2.default.extend({
    subViews: {
        header: function header() {
            return new _Header2.default();
        },
        content: function content() {
            return new _Content2.default();
        },
        footer: function footer() {
            return new _Footer2.default();
        }
    }
}));
...
},{"./Content":5,"./Footer":6,"./Header":8,"./LazyLoadView":9}],5:[function(require,module,exports){
'use strict';
...
var Content = function (_BiontView$extend) {
    _inherits(Content, _BiontView$extend);

    function Content() {
        _classCallCheck(this, Content);

        return _possibleConstructorReturn(this, _BiontView$extend.apply(this, arguments));
    }
...
},{"./Grid":7,"biont-backbone":"biont-backbone"}],6:[function(require,module,exports){
'use strict';
...
var Footer = function (_BiontView$extend) {
  _inherits(Footer, _BiontView$extend);
...
},{"biont-backbone":"biont-backbone"}],7:[function(require,module,exports){
'use strict';
...
var Grid = function (_BiontView$extend) {
    _inherits(Grid, _BiontView$extend);

    function Grid(data, args) {
        _classCallCheck(this, Grid);

        var _this = _possibleConstructorReturn(this, _BiontView$extend.call(this, data, args));

        _this.rendered = false;
        return _this;
    }

    Grid.prototype.render = function render(forced) {};
...
},{"biont-backbone":"biont-backbone"}],8:[function(require,module,exports){
'use strict';
...
var Header = function (_BiontView$extend) {
  _inherits(Header, _BiontView$extend);
...
},{"biont-backbone":"biont-backbone"}],9:[function(require,module,exports){
'use strict';
...
},{"./ScrollSpyView":10}],10:[function(require,module,exports){
'use strict';
...
}(_biontBackbone.BiontView);

exports.default = ScrollSpyView;

},{"biont-backbone":"biont-backbone","underscore":3}],11:[function(require,module,exports){
'use strict';
...
},{"./AppView":4}],12:[function(require,module,exports){
"use strict";
...
},{"../template-loader":14,"backbone":19,"underscore":21}],13:[function(require,module,exports){
'use strict';
...
},{"./BiontView":12}],14:[function(require,module,exports){
...
},{"./templateLoaders/DOMTemplateLoader":15,"./templateLoaders/ObjectTemplateLoader":16,"./templateLoaders/nodeTemplateLoader":18,"_process":2}],15:[function(require,module,exports){
'use strict';
...
},{"./abstractTemplateLoader":17}],16:[function(require,module,exports){
'use strict';
...
},{"./abstractTemplateLoader":17}],17:[function(require,module,exports){
'use strict';
...
}).call(this,"/../biont-backbone/dist/js/templateLoaders")
},{"./abstractTemplateLoader":17,"fs":1}],19:[function(require,module,exports){
(function (global){
//     Backbone.js 1.3.3
...
},{"dup":3}],"biont-backbone":[function(require,module,exports){
"use strict";
...
},{"./Views/BiontView":12,"./Views/ListView":13}]},{},[11]);
